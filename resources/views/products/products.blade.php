...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Parametres</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">Products</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
                            ...
                            <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                                data-toggle="modal" href="#exampleModal">ajouter un produit</a>
                       							</div>
							<div class="card-body">
								<div class="table-responsive">
                                    ...
                                    <th class="border-bottom-0">nom la section</th>
