...
<!-- la somme des totales de invoice -->
                                    {{ number_format(App\Models\invoices::sum('Total'), 2) }}
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">nbr invoices :{{ App\Models\invoices::count() }}</p>
								<!-- la somme des invoices -->
                            </div>
                                ...
                                <span class="text-white op-7">
                                    ...
                                    if($count_invoices2 == 0){
                                       echo $count_invoices2 = 0;
										...
										echo(round($count_invoices2));echo " %";
                                    }
                                    @endphp
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if($count_invoices1 == 0){
										   ...
										   echo(round($count_invoices1));echo " %";
                                        }
                                    @endphp
                                </span>
                            </span>
